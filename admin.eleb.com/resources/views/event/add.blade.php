    ...
    <form method="post" action="{{route('event.store')}}" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            <div class="col-xs-3">
                ...
                <input id="captcha" class="form-control" name="signup_start"  type="date">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-xs-3">
                <label for="exampleInputEmail1">结束时间</label>
                <input id="captcha" class="form-control" name="signup_end"  type="date">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-xs-3">
                <label for="exampleInputEmail1">开奖时间</label>
                <input id="captcha" class="form-control" name="prize_date"  type="date">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-xs-6">
                <label for="exampleInputEmail1">报名人数限制</label>
                <input name="signup_num" type="text" class="form-control" id="exampleInputEmail1" placeholder="人数" value="{{old('signup_num')}}">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-xs-3">
