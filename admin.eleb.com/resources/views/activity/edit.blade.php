    ...
    <form method="post" action="{{route('Activities.store')}}" enctype="multipart/form-data">
        <div class="form-group row">
            <div class="col-xs-6">
                ...
                <input name="title" type="text" class="form-control" id="exampleInputEmail1" placeholder="名称" value="{{$Activity->title}}">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-xs-6">
        ...
        <div class="form-group row">
            <div class="col-xs-3">
                ...
                <input id="captcha" class="form-control" name="start_time"  type="date" ng-value="vm.transform({{$Activity->start_time}})">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-xs-3">
