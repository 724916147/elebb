    ...
    <form method="post" action="{{route('MenuCategories.store')}}" enctype="multipart/form-data">
        <div class="form-group row">
            <div class="col-xs-6">
                ...
                <input name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="名称" value="{{old('name')}}">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-xs-6">
                <label for="exampleInputEmail1">菜品编号</label>
                <input name="type_accumulation" type="text" class="form-control" id="exampleInputEmail1" placeholder="菜品编号" value="{{old('type_accumulation')}}">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-xs-6">
